...
local function my_on_attach(bufnr)
  ...
  -- Git Navigation
  vim.keymap.set('n', '<leader>nt]c', api.node.navigate.git.next, opts('Next Git'))
  vim.keymap.set('n', '<leader>nt[c', api.node.navigate.git.prev, opts('Prev Git'))

  -- Diagnostics Navigation
  vim.keymap.set('n', '<leader>nt]e', api.node.navigate.diagnostics.next, opts('Next Diagnostic'))
  vim.keymap.set('n', '<leader>nt[e', api.node.navigate.diagnostics.prev, opts('Prev Diagnostic'))
